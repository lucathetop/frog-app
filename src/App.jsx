  ...
  return (
    <div style={{height:"100dvh",maxHeight:"100dvh",display:"flex",flexDirection:"column",
      ...
      <div style={{position:"fixed",bottom:0,left:0,right:0,
        ...
        {[
          {id:"frog",        label:"frog",    icon:"frog",    badge:pending>0},
          ...
          <button key={item.id}
            ...
            {item.isPost ? (
              <div style={{width:46,height:46,background:"#6db87a",borderRadius:"50%",
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                <path d="M12 15c-3.314 0-6-2.686-6-6V4h12v5c0 3.314-2.686 6-6 6z"
                  fill={tab==="leaderboard"?"#4a9457":"#8a7260"}/>
                <path d="M6 4H3v3c0 1.657 1.343 3 3 3"
                  stroke={tab==="leaderboard"?"#4a9457":"#8a7260"} strokeWidth="2" fill="none"/>
                <path d="M18 4h3v3c0 1.657-1.343 3-3 3"
                  stroke={tab==="leaderboard"?"#4a9457":"#8a7260"} strokeWidth="2" fill="none"/>
                <path d="M12 15v4M8 19h8"
                  stroke={tab==="leaderboard"?"#4a9457":"#8a7260"} strokeWidth="2" strokeLinecap="round"/>
              </svg>
            ) : (
